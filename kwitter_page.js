    ...
    firebase.database().ref("/" + room_name).on('value', function (snapshot) {
                ...
                snapshot.forEach(function (childSnapshot) {
                            ...
                            if (childKey != "purpose") {
                                ...
                                like_button = "<button class= 'button class= 'btn btn-warning' id=" + firebase_message_id + " value=" + like + " onclick='updateLike(this.id)'>Likes :" + like + "</button";
                        ...
                        childSnapshot.val(); if(childKey = childSnapshot.key; childData =
                            firebase_message_id = childKey;
                            message_data = childData;
